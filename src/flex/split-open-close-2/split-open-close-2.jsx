...
import './split-open-close-2.css';

class SplitOpenClose2 extends Component {
	constructor ( props ) {
		super ( props );
		...
		this.sizerMouseEnter    = this.sizerMouseEnter.bind ( this );
		this.sizerMouseLeave    = this.sizerMouseLeave.bind ( this );
		this.sizerMouseDown		= this.sizerMouseDown.bind ( this );
		this.sizerMouseUp		= this.sizerMouseUp.bind ( this );
		this.sizerMouseMove		= this.sizerMouseMove.bind ( this );


		this.contentMouseDown	= this.contentMouseDown.bind ( this );
		this.contentMouseUp		= this.contentMouseUp.bind ( this );
	...
	sizerMouseEnter ( ev ) {
		let sW = 'sizerMouseEnter()';
		console.log ( sW );

	}   //	sizerMouseEnter()

	sizerMouseLeave ( ev ) {
		let sW = 'sizerMouseLeave()';
		console.log ( sW );

	}   //	sizerMouseLeave()

	sizerMouseDown ( ev ) {
		let sW = 'sizerMouseDown()';
		console.log ( sW );
		this.drag.sizerMouseDown = true;
	...
	sizerMouseUp ( ev ) {
		let sW = 'sizerMouseUp()';
		console.log ( sW );
		if ( ! this.drag.sizerMouseDown ) {
			return; }
		this.drag.sizerMouseDown = false;
		this.drag.drageeId = '';
	}	//	sizerMouseUp()

	sizerMouseMove ( ev ) {
		let sW = 'sizerMouseMove()';
	//	console.log ( sW );
		if ( ! this.drag.sizerMouseDown ) {
			return; }
		this.sizeIt ( ev );
	...
	contentMouseDown ( ev ) {
		let sW = 'contentMouseDown()';
		console.log ( sW );
	}	//	contentMouseDown()

	contentMouseUp ( ev ) {
		let sW = 'contentMouseUp()';
		console.log ( sW );
		if ( ! this.drag.sizerMouseDown ) {
			return; }
		this.drag.sizerMouseDown = false;
			...
			<div className="split-open-close-2">
				<div id = "div-root" 
					...
					<div id = "rr-pe-a" 
						 ...
						 onMouseUp		= { this.contentMouseUp } >
						panel content
						<div id = "rr-pe-a-sizer" 
							 className = "sizer"
							 style = { this.state.sizer.style }
							 onMouseEnter	= { this.sizerMouseEnter }
							 onMouseLeave	= { this.sizerMouseLeave }
							 onMouseDown	= { this.sizerMouseDown }
							 onMouseUp		= { this.sizerMouseUp } 
							 onMouseMove	= { this.sizerMouseMove } >
...
}	//	class SplitOpenClose2

export default SplitOpenClose2;
